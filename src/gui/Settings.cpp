...
Settings::Settings(QWidget *parent)
  ...
  QFont font;
  font.setFamily(m_settings.value(FONT_FAMILY, "Cascadia Mono").toString());
  ...
  QGroupBox *font_settings_group = new QGroupBox("Шрифт");
  QHBoxLayout *font_settings_layout = new QHBoxLayout;
  font_settings_layout->addWidget(m_font_family);
  font_settings_layout->addWidget(new QLabel("Размер: "));
  ...
  // QPushButton *close_button = new QPushButton ("Отмена");
