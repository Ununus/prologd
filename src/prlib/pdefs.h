...
#define maxlinelen    1024    //длина строки редактора,и всякие промежуточные
                              // буфера
#define maxstac       13000   //размер стеков  ushort
#define maxbf         2048    //размер стека унификации
#define maxsarray     1000    //размер массива lpstr для вывода результата
#define deltasarray   100     //число на кот наращивается массив
#define maxgrarray    1000    //размер массива гр обьектов для вывода
#define deltagrarray  100     //число на кот наращивается массив
#define maxstaccalc   100     //стек для вычисления ар выр
#define deltastaccalc 10      //delta
