...
unsigned prrdint(unsigned sw, TScVar *ScVar, TClVar *ClVar, array *heap);  //ввод целого   !!!нужно ввод вещств
...
unsigned prterm(unsigned sw, TScVar *ScVar, TClVar *ClVar, array *heap);   //не понял для чего это поэтому 5
unsigned argone(unsigned name, TScVar *ScVar, TClVar *ClVar, array *heap);
