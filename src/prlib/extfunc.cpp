...
unsigned argnull(unsigned name, TScVar* ScVar, TClVar* ClVar, array* heap)
{
  ...
  case hptrace:
    ...
    //            sroptionsout.optionsrun |= tracce;//������
    break;
  case hpnottr:
...
unsigned argone(unsigned name, TScVar* ScVar, TClVar* ClVar, array* heap)
{
  ...
  case hpvar: return (sw == 5) ? 3 : 5;  // ���
  case hpint: return (sw == 7) ? 3 : 5;  // ���
  case hpfloat: return (sw == 6) ? 3 : 5;  //������������
  case hpsym: return (sw == 4) ? 3 : 5;  // ����
...
unsigned whatisit(unsigned sw, bool (*f)(char), unsigned i,
  TScVar* ScVar, TClVar* ClVar, array* heap)//������ unsigned i ???
{
  char lnwr[maxlinelen];                              //����� ���� unsignedi !!!
  int w;
  occ_line(0, lnwr, ScVar, ClVar, heap);
  int len = strlen(lnwr);
  switch (sw)
...
unsigned argtwo(unsigned name, TScVar* ScVar, TClVar* ClVar, array* heap)
{
  ...
  case hpterm: return prterm(sw, ScVar, ClVar, heap);       // ����    return 5;
...
//������ �������� VarOnList
int count_var;//
int VarOnList(baserecord* pb, TScVar* ScVar, TClVar* ClVar, array* heap);//������� ���������� � ������ ������ 1 ���� ������

int VarOnFunc(baserecord* pb, TScVar* ScVar, TClVar* ClVar, array* heap)//������� ���������� � ������� ������ 1 ���� ������
{
...
//            out("���������� ����������");
  ...
  default: out(const_cast<char*>("������������ ��� ���������� � '���'")); return 1;
  }
  if (!index)
  {
    heap->last = old_index;
  ...
  //������� � ������� �����������
  int number = occ(2, ScVar, ClVar, heap);//���� ������� �������� �����
  //������ ������ �����������
  tp = heap->GetPbaserecord(ScVar->goal[maxarity]);
  //(baserecord *)&heap->heaps[ScVar->goal[maxarity]];
...
unsigned pradd(unsigned sw, TScVar* ScVar, TClVar* ClVar, array* heap) //��������
{
  ...
  {
  case 777:
    return (l[0] + l[1] == l[2]) ? 3 : 5; //��� �����  ���
  case 666:
    return (f[0] + f[1] == f[2]) ? 3 : 5; //��� ������� ffff
  case 775:
...
unsigned prmul3(unsigned sw, TScVar* ScVar, TClVar* ClVar, array* heap)     //���������   � goal[0].. 1 .. �������� ��������
{
  long l[3];
  float f[3];
  bool fl = false;//���� ����� true �� ��������� ��� ����� �����
  ...
  switch (sw)
  {
  case 777:return (l[0] * l[1] == l[2]) ? 3 : 5; //��� �����  ���
  case 666:return (f[0] * f[1] == f[2]) ? 3 : 5; //��� ������� ffff
...
unsigned prmul(unsigned sw, TScVar* ScVar, TClVar* ClVar, array* heap)     //���������   � goal[0].. 1 .. �������� ��������
{
  long l[4];
  float f[4];
  bool fl = false;//���� ����� true �� ��������� ��� ����� �����
  ...
  switch (sw)
  {
  case 7777: return (l[0] * l[1] + l[2] == l[3]) ? 3 : 5; //��� �����  ����
  case 6666: return (f[0] * f[1] + f[2] == f[3]) ? 3 : 5; //��� ������� ffff
  case 5777:
    if (l[1])
    {
      long work;
  ...
  array* heap)
{
  ...
  {
  case hpline:
    return prger(sw, ScVar, ClVar, heap);//�����
  }
  return 1;
}
